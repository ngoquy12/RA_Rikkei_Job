...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col justify-center lg:flex-row">
      ...
      <div className="w-full min-w-[500px] overflow-hidden lg:w-1/2 flex items-center justify-center p-8 bg-white">
          ...
          <div className="space-y-6">
            ...
            <form className="space-y-6">
              ...
              <div className="text-center text-sm text-gray-600">
                ...
                <Link
                  to="/login"
                  className="text-[#AB1F24] font-semibold hover:text-red-600"
                >
                  Đăng nhập
                </Link>
              </div>
